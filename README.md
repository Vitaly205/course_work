...
**Цели проекта**:  
- Обеспечить простой и интуитивно понятный способ управления счетами.  
- Гарантировать безопасность данных и операций.  
- Поддерживать основные банковские функции, такие как просмотр баланса, переводы и история транзакций.  

### Студент  
**Имя**: Силльчук Виталий  
**Группа**: 353504 
